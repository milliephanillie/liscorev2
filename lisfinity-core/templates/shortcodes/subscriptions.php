				...
				<div
					...
					<?php while ( $packages->have_posts() ) : ?>
						...
						<div
							...
							<div id="<?php echo esc_attr( "discount--qty-$product_id" ); ?>" class="hidden text-sm text-red-600 mt-20"><?php _e( 'You get a discount of: ' ) ?><span class="discount"><?php echo esc_html( '0' ); ?></span></div>
