...
class PagesWidget extends Widget {
	...
	function __construct() {
		$this->setup( 'pages_widget', __( 'Lisfinity > Pages', 'lisfinity-core' ), __( 'Used to display pages as a list.', 'lisfinity-core' ), [
			Field::make( 'text', 'pages_title', __( 'Title', 'lisfinity-core' ) ),
			Field::make( 'multiselect', 'pages_pages', __( 'Title', 'lisfinity-core' ) )->set_help_text( __( 'Choose the pages you wish to display.', 'lisfinity-core' ) )
