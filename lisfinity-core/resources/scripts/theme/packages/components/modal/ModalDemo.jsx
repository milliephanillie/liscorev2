      ...
      <div
        ...
        <div className="modal--inner bg-white rounded shadow-xl overflow-hidden">
          ...
          <div className="modal--header flex justify-between items-center py-16 p-20 bg-grey-100">
            ...
            <h5
              className={`modal--title font-bold ${props.type === 'demo' ? 'text-red-600' : ''}`}>{title || lc_data.jst[606]}</h5>
            ...
            <div className="modal--header__right flex items-center">
              ...
              <button type="button" className="flex-center ml-20 text-sm text-grey-700" onClick={() => {
                props.closeModal();
                setOpen(false);
              }}>
                {lc_data.jst[463]}
