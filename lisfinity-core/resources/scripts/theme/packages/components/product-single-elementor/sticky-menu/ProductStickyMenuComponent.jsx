...
function ProductStickyMenuComponent(props) {
  ...
  return (
    ...
    >
      ...
      <div className={`flex flex-wrap menu-sticky--wrapper justify-between items-center p-20 bg-white rounded-b`}>
        <div
          className={`flex w-full title-container sm:w-1/2 ${classes} ${'auction' === product.product_meta.price_type ? 'product-auction' : ''}`}>
          {product.thumbnail &&
          <figure
            ...
            <img
              ...
              src={product?.thumbnail?.url ? product?.thumbnail?.url : iconSettings?.fallback_image}
        ...
        <div className={`product--price relative w-full sm:w-auto`}>
          <ProductPrice product={product} currentUser={currentUser} iconSettings={iconSettings} fromSticky/>
        </div>
      </div>
...
export default ProductStickyMenuComponent;
