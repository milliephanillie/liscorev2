...
const MenuMobileSearchEl = (props) => {
    ...
    <div className="filters flex-center mr-20">
      <button type="button"
        ...
        <ReactSVG
          ...
          className={`relative top-5 w-22 h-22 fill-white cst-color`}
        />
        }
        {showFilters &&
        <ReactSVG
          src={`${lc_data.dir}dist/${CloseIcon}`}
          className={`relative w-18 h-18 fill-white cst-color`}
          style={{
            top: 7,
          }}
        />
...
export default MenuMobileSearchEl;
