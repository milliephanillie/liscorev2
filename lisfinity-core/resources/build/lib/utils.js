 ...
 * API.
 */
module.exports.lisfinityPath = (basePath = '', destPath = '') =>
  path.resolve(path.dirname(__dirname), '../../../../themes/lisfinity', basePath, destPath);
...
module.exports.srcStaticsPath = destPath =>
  exports.srcPath('statics', destPath);
...
module.exports.distStaticsPath = destPath =>
  exports.distPath('statics', destPath);
